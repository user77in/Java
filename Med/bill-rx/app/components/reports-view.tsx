        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-zinc-500">Deep dive into your medical spending and savings.</p>
                </div>
                <div className="flex gap-2">
                    <Button variant="outline" className="gap-2"><Calendar className="w-4 h-4" /> This Year</Button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Savings Trend */}
                <GlassCard className="p-6 h-[400px] lg:col-span-2 flex flex-col">
                    <h3 className="text-lg font-bold text-zinc-900 mb-6">Cumulative Savings</h3>
                    <div className="flex-1 w-full min-h-0">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={savingsData}>
                                ...
                                />
                                <Area type="monotone" dataKey="savings" stroke="#2563EB" strokeWidth={3} fillOpacity={1} fill="url(#colorSavingsReport)" />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </GlassCard>
                ...
                <GlassCard className="p-6 h-[350px] flex flex-col">
                    <h3 className="text-lg font-bold text-zinc-900 mb-6">Spending by Provider</h3>
                    <div className="flex-1 w-full min-h-0">
                        <ResponsiveContainer width="100%" height="100%">
                ...
                {/* Error Distribution */}
                <GlassCard className="p-6 h-[350px] flex flex-col">
                    <h3 className="text-lg font-bold text-zinc-900 mb-6">Error Types Detected</h3>
                    <div className="flex-1 w-full min-h-0">
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                <Pie
                        ...
                        <div className="flex justify-center gap-4 mt-4">
                            {errorData.map((entry, index) => (
                                <div key={entry.name} className="flex items-center gap-2 text-xs text-zinc-600">
